...
:exclamation:  Please note, due to `ts-node` the CLI has currently a very long warum-up phase. This will be fixed soon.
...
`SnowFS` is licensed under the **MIT** license, please review the [LICENSE file](LICENSE.md).
